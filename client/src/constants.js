...
//getting URL for video player
export const INSTRUCTOR_ACTIVATION_REQUEST = 'INSTRUCTOR_ACTIVATION_REQUEST';
export const INSTRUCTOR_ACTIVATION_SUCCESS = 'INSTRUCTOR_ACTIVATIONL_SUCCESS';
export const INSTRUCTOR_ACTIVATION_FAILURE = 'INSTRUCTOR_ACTIVATION_FAILURE';

//getting URL for video player
export const INSTRUCTOR_DEACTIVATION_REQUEST = 'INSTRUCTOR_DEACTIVATION_REQUEST';
export const INSTRUCTOR_DEACTIVATION_SUCCESS = 'INSTRUCTOR_DEACTIVATIONL_SUCCESS';
export const INSTRUCTOR_DEACTIVATION_FAILURE = 'INSTRUCTOR_DEACTIVATION_FAILURE';

//getting URL for video player
export const STUDENT_ACTIVATION_REQUEST = 'STUDENT_ACTIVATION_REQUEST';
export const STUDENT_ACTIVATION_SUCCESS = 'STUDENT_ACTIVATIONL_SUCCESS';
export const STUDENT_ACTIVATION_FAILURE = 'STUDENT_ACTIVATION_FAILURE';

//getting URL for video player
export const STUDENT_DEACTIVATION_REQUEST = 'STUDENT_DEACTIVATION_REQUEST';
export const STUDENT_DEACTIVATION_SUCCESS = 'STUDENT_DEACTIVATIONL_SUCCESS';
export const STUDENT_DEACTIVATION_FAILURE = 'STUDENT_DEACTIVATION_FAILURE';